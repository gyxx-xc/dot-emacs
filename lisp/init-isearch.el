...
;; if nothing selected, search the pervious one,
;; if something select, search the selected one,
;; and do not keep select while the search
;; when the user are typing, remove the searrching things.
